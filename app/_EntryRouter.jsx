...
/**
 * The client half of `/`. This is the body of what used to be `app/page.js`,
 * moved out unchanged so that the page itself can stay a server component and
 * export metadata — a `'use client'` page cannot.
 *
